...
exports.overrideDefaultRules = void 0;
const types_1 = require("../types");
const overrideDefaultRules = (defaultRules, ruleConfig) => {
    const registeredRules = {};
    for (const [_, ruleValue] of Object.entries(defaultRules)) {
        registeredRules[ruleValue.meta.name] = {
            rule: ruleValue,
            options: {},
            severity: types_1.RULE_SEVERITY.ERROR
        };
    }
...
exports.overrideDefaultRules = overrideDefaultRules;
